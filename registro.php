...
if(($Nombre==NULL) or ($Nombre=='NOMBRE') or ($Apellido==NULL) or ($Apellido=='APELLIDO') or ($Email==NULL) or ($Email=='EMAIL') or ($Cedula==NULL) or ($Cedula=='CEDULA') or ($Telefono==NULL) or ($Telefono=='TELEFONO') or ($Ciudad==NULL) or ($Ciudad=='ESTADO / CIUDAD') or ($Direccion==NULL) or ($Direccion=='DIRECCION EXACTA DE ENTREGA') or ($Clave==NULL)) { $msj=1; }
...
<input name="empresa" type="hidden" id="empresa" value="0" />
  <table width="400" border="0" align="center" cellpadding="3" cellspacing="0">
    ...
    <tr>
	  ...
	  <p><a href="<?php if ($_SESSION['bebe']) { echo 'registro.php?e=1&id='.$_SESSION['idU']; } else { echo 'registro.php'; } ?>" class="link">Intenta nuevamente</a></p>
      </td>
    </tr>
    ...
    <tr>
      ...
      <b>(x) Registro Fallido.</b><br />
      <br />
      Tu <u>email ó cedula ya esta registrado<br />
    ...
    if ($_SESSION['bebe']=="") { ?>
    <tr>
      <td align="center" class="box">Para registrar una Empresa ó Persona Jurídica,<br />
        <a href="registro-juridica.php" class="link">haga click aquí</a></td>
    </tr>
    <? } ?>
    <tr>
      <td height="10"></td>
    ...
    <tr>
      <td align="center" class="txt-error-msg"><input name="cedula" type="text" class="fields rounded required noPlaceholder" id="cedula" style="background-image:url(images/icon-cedula.png)" value="<?php if ($_SESSION['bebe']!="") { echo $d['cedula']; } else { echo 'CEDULA'; } ?>" onfocus="if (this.value=='CEDULA') this.value = ''" onblur="if (this.value=='') this.value = 'CEDULA'" /></td>
    </tr>
    <tr>
