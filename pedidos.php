...
<title>Pedidos - Cositas de Bebe - Pretel</title>
...
<div id="pedido-type">
Si deseas comprar al Detal, haz <a href="pedidos-detal.php#pedidos" class="link">click aquí</a>
</div>
<?php } ?>
...
<p align="left" style="line-height:40px; font-size:19px;">
&#8226; Sólo venta Al Mayor a partir de 12 piezas.<br />
<!-- &#8226; <strong>Descuento de 10% para 24 piezas o más</strong><br / -->
&#8226; Espera nuestra confirmaci&oacute;n antes de pagar.<br />
...
<span style="line-height:normal;">&#8226; La columna &quot;<em>Cantidad</em>&quot; muestra la cantidad<br />
<span style="padding-left:15px;">m&iacute;nima de compra por referencia. Si deseas</span><br />
<span style="padding-left:15px;">más, puedes ingresar la que tu desees.</span></span></p>
</div>
...
<div class="cols" style="width:100px; text-align:center;"><input id="cant<?=$datos['idProd']?>" name="cant<?=$datos['idProd']?>" type="text" class="fields-pedido rounded" style="width:40px; text-align:center;" value="<?=$datos['cant']?>" maxlength="4" onblur="if(this.value < <?=$datos['cant']?>) {this.value = <?=$datos['cant']?>}; recalc(<?=$datos['idProd']?>)" /></div>
<div class="cols" style="width:135px; text-align:right;"><input id="precio<?=$datos['idProd']?>" name="precio<?=$datos['idProd']?>" type="text" class="fields-pedido rounded" style="width:100px;" readonly="readonly" value="x Consultar<? // =$datos['precioM'] ?>" /></div>
...
TOTAL&nbsp; <input id="granTotal" name="granTotal" type="text" class="field-monto-total fields-pedido required rounded" style="width:110px; font-weight:bold; color:#ef773a" readonly="readonly" />
</div>
<p align="center">
